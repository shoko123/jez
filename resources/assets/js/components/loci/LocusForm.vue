    ...
    <template v-if="locus">
      ...
      <v-layout row wrap ma-0 pa-0>
        <v-flex xs12 lg4 class="px-1">
          <v-textarea v-model="locus.description" rows="1" auto-grow readonly label="description" filled></v-textarea>
        </v-flex>
        ...
        <v-flex xs12 lg4 class="px-1">
          <v-textarea v-model="locus.registration_notes" rows="1" auto-grow readonly label="registration notes" filled></v-textarea>
        </v-flex>
      </v-layout>
      </v-card-text>
      </v-card>

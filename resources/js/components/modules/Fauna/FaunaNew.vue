<template>
  <v-container fluid>
    ...
    <v-row class="ga-1">
      ...
      <v-text-field v-model="nf.weight" label="Weight" :error-messages="errors.weight" max-width="10%" filled />
    </v-row>
    ...
    <v-row class="ga-1">
      ...
      <v-text-field v-model="nf.bone" label="Bone/Tooth" :error-messages="errors.bone" filled />
    </v-row>
...
const defaultsAndRules: TFieldsDefaultsAndRules<'Fauna'> = {
  ...
  code: { d: 'LB', r: { required, minValue: minLength(2), maxLength: maxLength(2) } },

...
class GlassValidationRules extends ValidationRules
{
    ...
    public function commonRules()
    {
        return [
            ...
            'data.fields.pontil_diameter' => 'numeric|between:1,500',
            'data.fields.primary_classification_id' => 'required|exists:glass_primary_classifications,id',
        ];
    }
    ...
    {
        return  collect($this->commonRules())
            ->merge(['data.fields.id' => 'required|exists:glass,id',])
            ->toArray();
    }
}

...
{
    //receives sceneable type and sceneable_id in query string
    //returns scene item is in with related media.
    public function withOneMedia($id)
    {
        $scene = Scene::with(
            ['sceneables',
                'media',
    ...
    public function withAllMedia($id)
    {
        $scene = Scene::with(
            ['sceneables',
                'media',
    ...
    public function byItemWithOneMedia(Request $request)
    {
    ...
    public function byItemWithAllMedia(Request $request)
    {
        $scenes = Sceneable::select('scene_id', 'sceneable_type', 'sceneable_id')->with(
            [
                'scene' => function ($q) {
